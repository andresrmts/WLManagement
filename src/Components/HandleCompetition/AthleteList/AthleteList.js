			    	...
			    	<table className="f6 w-100 mw8" cellSpacing="0">
				      <thead>
				        <tr className="stripe-dark">
				          ...
				          <th id="age" className="fw6 pa3 bg-white">Age</th>
				          <th id="weight" className="fw6 pa3 bg-white">Weight</th>
				          <th id="snatch" className="fw6 pa3 bg-white">Snatch</th>
				          <th id="cnj" className="fw6 pa3 bg-white">CNJ</th>
				          <th id="coachname" className="fw6 pa3 bg-white">Coach Name</th>
				        </tr>
				      </thead>
